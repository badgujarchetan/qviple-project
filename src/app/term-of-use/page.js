    ...
    <div className="term-of-use-section">
      ...
      <div className="term-hero">
        <div className="container-term">
          <h1 className="h1-term">Terms of Use</h1>
        </div>
      </div>
      <div className="container-main">
        <div className="bg-container">
          ...
          <p className="p-bg">2.1. This Site is owned, operated, managed and issued by the Bank, which is licensed to conduct banking business by the Financial Services Unit of the Commonwealth of Dominica. The Site is primarily intended for those who access it from outside the Eastern Caribbean Currency Union. Because of this, we cannot guarantee that the Site or the information thereon complies with law or regulation of other countries, or is appropriate for use, in other places.</p>
          <p className="p-bg">2.2. You are wholly responsible for the use of the Site by any person using your computer and you must ensure that any such person complies with these Terms. The information provided on this Site is not intended for distribution to, or use by, any person in any jurisdiction where such distribution or use would be contrary to law or regulation. This Site should not be considered as communicating any invitation or inducement to engage in banking or investment activity or any offer to buy or sell any securities or other instruments. The Bank reserves the right to adjust fees at anytime. The Bank reserves the right to amend, withdraw or not release any product or services at its sole discretion.</p>
          <h3 className="h3-bg">3. Country Guidelines</h3>
          <p className="p-bg">3.1. Not all products, services and investments described on this site are available in all jurisdictions and some are available on a limited basis only, due to local regulatory and legal requirements. The material on the pages of this Site is not intended for use by persons located in or a resident in jurisdictions which restrict the distribution of this material by us. Persons accessing these pages are required to inform themselves about and observe any relevant restrictions.</p>
          <p className="p-bg">3.2. This Site does not constitute an invitation to buy or the solicitation of an offer to sell products, services, investments or securities in any jurisdiction to any person to whom it is unlawful to make such an offer or solicitation in such jurisdiction.</p>
        </div>
      </div>
